...
if($_POST['parentId'] != '' )
{
			...
			$missionArray = $msnObj->getAllCompletedMissionsByParentId($parentId,$currentdate);
				...
				else
				{
					...
					$marray['error']['message'] = "You have no completed missions. Complete a new mission and stash your cash!";
