 ...
 */
typealias FBSDKDeferredAppLinkHandler = (_ url: URL, _ error: Error?) -> Void
/**
  Describes the callback for fetchOrganicDeferredAppLink.
 - Parameter url: the url representing the deferred App Link
 */
typealias FBSDKDeferredAppInviteHandler = (_ url: URL) -> Void
/**
...
class FBSDKAppLinkUtility: NSObject {
     ...
     */
    class func fetchDeferredAppLink(_ handler: FBSDKDeferredAppLinkHandler) {
    }
    /**
    ...
    class func fetchDeferredAppInvite(_ handler: FBSDKDeferredAppInviteHandler) -> Bool {
    }
}
/*
...
class func appInvitePromotionCode(from url: URL) -> String {
}