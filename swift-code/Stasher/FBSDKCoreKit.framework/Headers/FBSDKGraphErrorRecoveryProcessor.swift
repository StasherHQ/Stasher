 ...
 */
protocol FBSDKGraphErrorRecoveryProcessorDelegate: NSObjectProtocol {
    /**
     ...
     */
    func processorDidAttemptRecovery(_ processor: FBSDKGraphErrorRecoveryProcessor, didRecover: Bool, error: Error?)
    /**
     ...
     */
    func processorWillProcessError(_ processor: FBSDKGraphErrorRecoveryProcessor) throws
}
/**
...
class FBSDKGraphErrorRecoveryProcessor: NSObject {
     ...
     */
    private(set) weak var delegate: FBSDKGraphErrorRecoveryProcessorDelegate?
    /**
    ...
    func didPresentError(withRecovery didRecover: Bool, contextInfo: UnsafeMutableRawPointer) {
    }
}