 ...
 */
class FBSDKApplicationDelegate: NSObject {
    /**
      Gets the singleton instance.
     */
    class func sharedInstance() -> FBSDKApplicationDelegate {
    }
    /**
    ...
    func application(_ application: UIApplication, open url: URL, options: protocol<UIApplicationOpenURLOptionsKey, id>) -> Bool {
    }
#endif
    /**
