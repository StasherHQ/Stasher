 ...
 */
class FBSDKShareOpenGraphObject: FBSDKShareOpenGraphValueContainer, FBSDKCopying, NSSecureCoding {
    /**
     ...
     */
    convenience init(properties: [AnyHashable: Any]) {
    }
    /**
    ...
    func isEqual(to object: FBSDKShareOpenGraphObject) -> Bool {
    }
}