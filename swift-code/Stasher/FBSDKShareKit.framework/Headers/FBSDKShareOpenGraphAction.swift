 ...
 */
class FBSDKShareOpenGraphAction: FBSDKShareOpenGraphValueContainer, FBSDKCopying, NSSecureCoding {
    /**
     ...
     */
    convenience init(type actionType: String, object: FBSDKShareOpenGraphObject, key: String) {
    }
    /**
      Convenience method to build a new action and set the object for the specified key.
     - Parameter actionType: The action type of the receiver
    ...
    convenience init(type actionType: String, objectID: String, key: String) {
    }
    /**
      Convenience method to build a new action and set the object for the specified key.
     - Parameter actionType: The action type of the receiver
    ...
    convenience init(type actionType: String, objectURL: URL, key: String) {
    }
    /**
    ...
    func isEqual(to action: FBSDKShareOpenGraphAction) -> Bool {
    }
}