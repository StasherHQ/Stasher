...
/**
 ...
 yourself.
 */
class FBSDKShareAPI: NSObject, FBSDKSharing {
    /**
     ...
     */
    class func share(with content: FBSDKSharingContent, delegate: FBSDKSharingDelegate) -> FBSDKShareAPI {
    }
    /**
    ...
    func createOpenGraphObject(_ openGraphObject: FBSDKShareOpenGraphObject) -> Bool {
    }
    /**
