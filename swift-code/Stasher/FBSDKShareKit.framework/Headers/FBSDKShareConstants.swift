...
enum FBSDKShareErrorCode : Int {
    ...
    /**
     ...
     Use the canShare methods to check for this case before calling show.
       */
    case fbsdkShareDialogNotAvailableErrorCode
    /**
       @The error code for unknown errors.
       */
    case fbsdkShareUnknownErrorCode
}