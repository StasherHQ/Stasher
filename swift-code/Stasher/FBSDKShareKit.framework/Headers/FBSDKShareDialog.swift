 ...
 */
class FBSDKShareDialog: NSObject, FBSDKSharingDialog {
    /**
     ...
     */
    class func show(from viewController: UIViewController, with content: FBSDKSharingContent, delegate: FBSDKSharingDelegate) -> FBSDKShareDialog {
    }
    /**
