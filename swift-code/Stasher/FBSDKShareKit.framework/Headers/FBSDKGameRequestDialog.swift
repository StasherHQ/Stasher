 ...
 */
class FBSDKGameRequestDialog: NSObject {
    /**
     ...
     */
    class func show(with content: FBSDKGameRequestContent, delegate: FBSDKGameRequestDialogDelegate) -> FBSDKGameRequestDialog {
    }
    /**
     ...
     */
    var isFrictionlessRequestsEnabled: Bool = false
    /**
