 ...
 */
enum FBSDKLoginButtonTooltipBehavior : Int {
...
*/
class FBSDKLoginButton: FBSDKButton {
    /**
    ...
    /**
     ...
     an NSArray for the convenience of literal syntax.
     */
    var readPermissions = [Any]()
    /**
      Gets or sets the desired tooltip behavior.
     */
    var tooltipBehavior = FBSDKLoginButtonTooltipBehavior(rawValue: 0)
    /**
 ...
 */
protocol FBSDKLoginButtonDelegate: NSObjectProtocol {
    /**
