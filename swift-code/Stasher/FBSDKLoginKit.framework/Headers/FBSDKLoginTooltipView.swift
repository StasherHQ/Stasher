 ...
 */
protocol FBSDKLoginTooltipViewDelegate: NSObjectProtocol {
    /**
     ...
     */
    func loginTooltipView(_ view: FBSDKLoginTooltipView, shouldAppear appIsEligible: Bool) -> Bool
    /**
    ...
    func loginTooltipViewWillAppear(_ view: FBSDKLoginTooltipView)
    /**
    ...
    func loginTooltipViewWillNotAppear(_ view: FBSDKLoginTooltipView)
}