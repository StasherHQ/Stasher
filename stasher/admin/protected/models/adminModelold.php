...
class adminModel extends CFormModel
{
	 ...
	 ***/
	function get_user_list($search_text,$usertype)
	{
		$status_cond = '';
		$search_cond = '';
		$usertype_cond = '';		
		...
		if($usertype != '')
		{
			...
			$usertype_cond = " AND  u.usertype = '".$utpe."' ";
		}
		else
		{
			$usertype_cond = " AND ( u.usertype = '3' OR u.usertype='4' )";
		}			
...
function getChildListByParentId($user_id)
	...
	{
		$sql = "UPDATE tbl_user_relation set status= '0'
