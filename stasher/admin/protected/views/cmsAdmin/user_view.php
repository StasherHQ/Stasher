...
?>)</td>
	<td><a href="<?php echo Yii::app()->request->baseUrl; ?>/cmsAdmin/user/edit/?id=<?php echo base64_encode($newdata->userId);?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/assets/images/editIcon.svg" /></a>
                                ...
                                <a title="Mission List" href="<?php echo Yii::app()->request->baseUrl; ?>/cmsAdmin/mission/user/?id=<?php echo base64_encode($newdata->userId);?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/assets/images/mission.png" /></a> </td>
</tr>
